...
const headCells = [
  ...
  { id: 'loft', numeric: true, disablePadding: false, label: 'Loft' },
  { id: 'material', numeric: true, disablePadding: false, label: 'Material' },
  { id: 'price', numeric: true, disablePadding: false, label: 'Cheapest Price' },
];
...
export default function ProductTable({ rows }) {
  ...
  const [orderBy, setOrderBy] = React.useState('club');
  ...
  const handleSelectAllClick = (event) => {
    if (event.target.checked) {
      const newSelected = rows.map((n) => n.club);
          ...
          >
            ...
            <TableBody>
              {visibleRows.map((row) => {
                ...
                const labelId = `enhanced-table-checkbox-${row.club}`;
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="right">{row.hand}</TableCell>
                    <TableCell align="right">{row.loft}</TableCell>
